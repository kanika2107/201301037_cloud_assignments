#!/usr/bin/python
'''Creating a topology of y switches where each switch is connected to two hosts and testing the ping such that odd hosts are able to ping only each other with the bandwidth of 2mbps for even hosts and 1mbps for odd hosts'''
...
class LinearTopo(Topo):
	"Topology of Y switches, with two hosts per switch and all switches connected to each other in a circular fashion ie a loop."
